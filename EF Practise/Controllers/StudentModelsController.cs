...
namespace EF_Practise.Controllers
{
    public class StudentModelsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,RollNo,Name,Dept,DOB")] StudentModel studentModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,RollNo,Name,Dept,DOB")] StudentModel studentModel)
        {
